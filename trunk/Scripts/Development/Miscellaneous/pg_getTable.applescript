-- echo 'SELECT 1;' | /Library/PostgreSQL/8.4/bin/psql -w -q --tuples-only -h relatedfolks.com -p 5432 -d genealogy -U postgres
property aQuery : "SELECT 1,2,'three'; select ';'; select 'one','two'"
